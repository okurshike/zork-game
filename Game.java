    ...
    private void goRoom(String direction, Scanner scanner) {
        ...
        if (nextRoom == null) {
            ...
            if (currentRoom == wald) {
                ...
                System.out.println("Du bist wieder in der Kirche. Jedoch felt es dir erst jetzt auf, dass in dem weitesten, dünkleren Ecke des Raums steht es ein Opferaltar. \nDu entscheidest, den Objekt von Friedhof dadrauf zu stellen. Und - du siehst den hellen zum Himmel ausstralenden Licht. \nEs ist ein guter Zeichen. \nTO BE CONTINUED");
                System.exit(0);
            }
